...
NIMBUS is an Air Quality Analytics & Enforcement Platform built for hackathon deployment. It leverages FastAPI for the backend (Python-based) and React + Vite for the frontend.
...
Refer to individual directories for specific setup and run instructions:
...
- [Hackathon Strategy](./ET-AI_DOCS/ET_AI_Hackathon_Strategy.md)
