...
def run_migrations_offline() -> None:
    ...
    """
    url = os.getenv("DATABASE_URL", "postgresql://postgres:postgres@localhost:5432/nimbus")
    context.configure(
        url=url,
...
def run_migrations_online() -> None:
    ...
    """
    db_url = os.getenv("DATABASE_URL", "postgresql://postgres:postgres@localhost:5432/nimbus")
